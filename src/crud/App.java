...
public class App {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        declaracao.execute("CREATE TABLE if not exists PESSOA(ID INT NOT NULL IDENTITY, NOME VARCHAR(255) NOT NULL UNIQUE, TELEFONE VARCHAR(20) ,ENDERECO VARCHAR(255), IDCIDADE INTEGER NOT NULL);");
